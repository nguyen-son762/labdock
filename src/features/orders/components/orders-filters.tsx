...
import { orderFilterStatusSchema, type OrderFilters, type OrderStatus } from "../schemas/order.schema";
...
export function OrdersFilters({ filters, onSearchChange, onStatusChange, onMonthChange, onClear }: OrdersFiltersProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <Select value={filters.status} onValueChange={(value) => onStatusChange(orderFilterStatusSchema.parse(value))}>
        <SelectTrigger
