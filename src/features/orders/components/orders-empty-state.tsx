...
export function OrdersEmptyState({ onClear }: { onClear: () => void }) {
  return (
    <section className="rounded-xl border border-dashed border-[#c8d0d9] bg-white px-5 py-16 text-center">
      ...
      <h2 className="mt-4 text-lg font-semibold text-[#0f3678]">No orders found</h2>
      <p className="mt-1 text-sm text-[#73798f]">Try changing your search or order status.</p>
